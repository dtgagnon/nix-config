...
in {
  config = mkIf cfg.enable {
    spirenix.desktop.hyprland.extraKeybinds = {
      bind = [
        "${cfg.primaryModifier}, Return, exec wezterm"
        ...
        "${cfg.primaryModifier}_CONTROL, h, focusmonitor l"
        "${cfg.primaryModifier}_CONTROL, l, focusmonitor r"
        "${cfg.primaryModifier}_CONTROL, k, focusmonitor u"
        "${cfg.primaryModifier}_CONTROL, j, focusmonitor d"
        ...
        "${cfg.primaryModifier}_ALT, h, movecurrentworkspacetomonitor l"
        "${cfg.primaryModifier}_ALT, l, movecurrentworkspacetomonitor r"
        "${cfg.primaryModifier}_ALT, k, movecurrentworkspacetomonitor u"
        "${cfg.primaryModifier}_ALT, j, movecurrentworkspacetomonitor d"
        ...
        "${cfg.primaryModifier}_SHIFT, u, movetoworkspace special"
      ];
      bindi = [
