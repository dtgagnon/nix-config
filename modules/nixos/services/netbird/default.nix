...
in
{
  options.${namespace}.services.netbird = {
    ...
    openFirewall = mkBoolOpt false "Open firewall ports for peer-to-peer communication";
    useRoutingFeatures = mkOpt types.str "none" "Enable advanced routing (Network Resources, Routes, exit nodes)";
  };
