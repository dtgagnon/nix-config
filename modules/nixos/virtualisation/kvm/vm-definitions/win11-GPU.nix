...
{
  win11-GPU = pkgs.writeText "win11-GPU.xml" ''
    <domain type='kvm' xmlns:qemu='http://libvirt.org/schemas/domain/qemu/1.0'>
      ...
      <os firmware='efi'>
        ...
        <nvram template='${pkgs.qemu}/share/qemu/edk2-i386-vars.fd' templateFormat='raw' format='raw'>/var/lib/libvirt/qemu/nvram/win11-GPU_VARS.fd</nvram>
        <boot dev='hd'/>
        <smbios mode='host'/>
      </os>
      <features>
