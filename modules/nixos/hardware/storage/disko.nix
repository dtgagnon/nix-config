...
in {
  ...
  config = mkIf (cfg.enable && cfg.partitioning.enable) {
    assertions = [
      {
          ...
          content = {
            ...
            partitions = {
              ...
              root = {
                ...
                size = "100%";
                content = let
                  # Function to create filesystem-specific configuration
                  # This handles the creation of either:
                  # 1. ZFS pool with optional datasets
                  # 2. Btrfs filesystem with optional subvolumes
                  # 3. Basic filesystem (ext4) with root mountpoint
                  mkFsConfig = fs: let
                  ...
                  in
                    ...
                    if fs == "zfs" then {
                      type = "zfs";
                      pool = "rpool"; # rpool or zpool? What's the diff?
                ...
                in
                # Main decision point: LVM or direct filesystem
